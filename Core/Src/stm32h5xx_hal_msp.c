...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    */
    ...
    handle_GPDMA2_Channel2.Init.Request = GPDMA2_REQUEST_UART5_TX;
    ...
    handle_GPDMA2_Channel1.Init.Request = GPDMA2_REQUEST_UART5_RX;
    ...
    handle_GPDMA2_Channel1.Init.Priority = DMA_HIGH_PRIORITY;
